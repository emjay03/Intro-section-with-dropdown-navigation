...
function Navbar() {
  const [icon1, setIcon1] = useState("plus1");
  const [icon2, setIcon2] = useState("plus2");
  ...
  return (
    <div className="max-w-[1440px] min-h-[140px] m-auto 3 flex justify-between items-center   px-10">
      <div className="mr-1">
      ...
      <div className="hidden md:flex w-full justify-between py-10 ">
        <ul className="flex items-center text-sm justify-center px-10 text-MediumGray ">
          <div className="relative inline-block text-left ">
            <div>
              <button
                type="button"
                onClick={handleClick}
                className="inline-flex w-full justify-center items-center bg-white px-4 py-2  font-medium  focus:outline-none hover:text-AlmostBlack "
                id="menu-button"
                aria-expanded="true"
                aria-haspopup="true"
              >
            ...
            {ShowOptions && (
              <div
                className="absolute right-2 z-10 mt-2 w-44 px-4 z-99 origin-top-right rounded-md bg-White shadow-xl focus:outline-none"
                role="menu"
              ...
              >
                <div className="py-1" role="none">
                  ...
                  <form method="POST" action="#" role="none">
                    <button
                      type="submit"
                      className="text-gray-700 flex w-full px-4 py-2 text-left text-sm"
                      role="menuitem"
                      tabIndex="-1"
                      id="menu-item-3"
                    >
          ...
          <div className="relative inline-block text-left ">
            ...
            {ShowCompany && (
              <div
                className="absolute left-4 z-10 mt-2 w-44  origin-top-right rounded-md bg-White shadow-xl focus:outline-none"
                role="menu"
                aria-orientation="vertical"
                aria-labelledby="menu-button"
                tabIndex="-1"
          ...
          <li className=" items-center relative inline-block px-5">
            <button className="flex items-center text-md border-none cursor-pointer">
              Career
            </button>
        ...
        <div className="flex text-sm ">
          ...
          <button className="border-2 border-black rounded-2xl px-10 py-2 hover:bg-AlmostBlack hover:border-none hover:text-AlmostWhite">
            Register
          </button>
        </div>
      </div>
      ...
      <div
        className={
          nav
            ? "overflow-y-hidden md:hidden ease-in duration-300 absolute  right-0 top-0  tr:h-[780px] h-[1140px] w-full bg-MediumGray/50 px-4 py-7 "
            : "absolute top-0  h-[1300px] w-[50%] left-[-100%] ease-in duration-500"
        }
      >
        <ul className=" h-[1140px]  w-auto  px-10 absolute top-0 right-0 text-md pt-[87px] text-MediumGray  bg-AlmostWhite">
          <div className="pr-14">
            <div className="relative text-left ">
              <div>
                <button
                  type="button"
                  onClick={handleClick}
                  className="inline-flex w-full  items-center bg-white px-4 py-2  font-medium  focus:outline-none hover:text-AlmostBlack "
                  id="menu-button"
                  aria-expanded="true"
                  aria-haspopup="true"
                >
              ...
              {ShowOptions && (
                <div
                  className=" mt-2 w-auto px-4 origin-top-right rounded-md bg-white focus:outline-none"
                  role="menu"
                  aria-orientation="vertical"
                  aria-labelledby="menu-button"
                  tabIndex="-1"
          ...
          <div className="flex justify-center text-center w-full  ">
            <div>
              <button
                type="button"
                className="flex w-full  justify-center text-center bg-white px-4 py-4  font-medium  focus:outline-none hover:text-AlmostBlack "
                id="menu-button"
                aria-expanded="true"
                aria-haspopup="true"
              >
          ...
          <div className="flex justify-center text-center w-full   ">
            <div>
              <button
                type="button"
                className="flex w-full rounded-lg border-2 hover:bg-AlmostBlack hover:text-AlmostWhite border-MediumGray justify-center text-center bg-white px-14 py-2  font-medium  focus:outline-none hover:border-none"
                id="menu-button"
                aria-expanded="true"
                aria-haspopup="true"
              >
